...
func authorizeEndpoint(svc auth.Service) endpoint.Endpoint {
	return func(ctx context.Context, request interface{}) (interface{}, error) {
		...
		err := svc.Authorize(ctx, auth.PolicyReq{ObjectType: req.ObjType, Object: req.Obj, Relation: req.Act, SubjectType: req.SubType, Subject: req.Sub})
		if err != nil {
			return authorizeRes{}, err
		}
...
func addPolicyEndpoint(svc auth.Service) endpoint.Endpoint {
	return func(ctx context.Context, request interface{}) (interface{}, error) {
		...
		err := svc.AddPolicy(ctx, auth.PolicyReq{ObjectType: req.ObjType, Object: req.Obj, Relation: req.Act, SubjectType: req.SubType, Subject: req.Sub})
		if err != nil {
			return addPolicyRes{}, err
		}
